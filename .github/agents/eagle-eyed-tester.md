...
tools: ['read', 'execute', 'search', 'read/problems', 'oraios/serena/*', 'playwright/*']
agents: []
handoffs:
...
- **Test Runner**: Use `execute/runTests` to run Vitest and Playwright tests
...
- Or use `execute/runTests` to run the test suite
...
**Precision**:
- Use `execute/runTests` to run the full test suite
...
<testing_focus>
For the MealTracker component, verify:

**Functionality**:
- [ ] All seven Hobbit meals can be tracked
- [ ] Add meal functionality works correctly
- [ ] Remove meal functionality works correctly
- [ ] Meal statistics calculate correctly (totals, averages, etc.)
- [ ] Component handles empty state gracefully
- [ ] Component handles maximum capacity appropriately

**Code Quality**:
- [ ] TypeScript types are properly defined and used
- [ ] Vue Composition API is used idiomatically
- [ ] Component is properly structured
- [ ] Props and emits are correctly defined
- [ ] Scoped CSS doesn't leak styles

**Tests**:
- [ ] Unit tests cover all component methods
- [ ] Unit tests verify computed properties
- [ ] E2E tests cover user workflows
- [ ] Tests follow existing patterns in codebase
- [ ] Test assertions are specific and meaningful

**Integration**:
- [ ] Component integrates properly with App.vue
- [ ] Component follows project conventions
- [ ] LOTR/Hobbit theme is consistent
...
**Workflow:**
1. Receive MealTracker implementation to test
...
4. Run all unit tests using `execute/runTests` or `execute/runInTerminal` (Vitest)
